...
<main class="flex flex-col w-full pt-19">
    ...
    <section class="relative w-full h-[700px] overflow-hidden shadow-lg">
        ...
        <img src="./assets/images/sms10.png"
            alt="Student Management System" class="w-full h-full object-cover">
        <div class="absolute inset-0 z-20 flex items-center">
            <div class="container text-white max-w-3xl">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Welcome to Tagoloan Community College</h1>
                <p class="text-xl opacity-90">Empowering students through innovation, integrity, and excellence.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="mt-8">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start">
                                <span class="text-[#2C5282] font-bold mr-3">•</span>
    ...
    <section class="section bg-gray-50">
        ...
        <div class="container mx-auto mt-12">
            ...
            <!-- Engineering -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://www.tcc.edu.ph/assets/logo/eng1.png" alt="Engineering" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Engineering</p>
                <p class="font-bold text-gray-700 text-center">Sustainable design & innovation.</p>
            </div>

            <!-- Education -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://www.tcc.edu.ph/assets/logo/educ.png" alt="Education" class="w-44 h-44 object-cover rounded-xl mb-4">
            ...
            <!-- Hospitality -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ8L9bPDN-TIVhAVhMVbPIYfmTFiPpqnC-fQ&s  " alt="Hospitality" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Hospitality</p>
                <p class="font-bold text-gray-700 text-center">Excellence in service.</p>
            </div>

            <!-- Business -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8dzuMLEXIobHLGp6FyFPmxsq1vzGtTM6S2HrJBs0YowPtEdmkyxiP-CgZlUO9VpmS9t8&usqp=CAU" alt="Business" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Business</p>
            ...
            <!-- Arts & Design -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://www.tcc.edu.ph/assets/logo/arts.jpg" alt="Arts & Design" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Arts & Design</p>
                <p class="font-bold text-gray-700 text-center">Creativity with purpose.</p>
            </div>

            <!-- Information Technology -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://www.tcc.edu.ph/assets/logo/it.png" alt="Mathematics" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Information Technology</p>
                <p class="font-bold text-gray-700 text-center">Logic & problem-solving.</p>
            </div>

            <!-- Social Sciences -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://www.tcc.edu.ph/assets/logo/blis.png" alt="Social Sciences" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Library Information Science</p>
                <p class="font-bold text-gray-700 text-center">Understanding society.</p>
            </div>

            <!-- Physical Education -->
            <div class="photo-slide flex flex-col items-center bg-gray-50 p-6 rounded-2xl shadow-lg">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZYtJx3wbtjPu23euXi5IKwcU3GRIcf22qyQ&s" alt="Physical Education" class="w-44 h-44 object-cover rounded-xl mb-4">
                <p class="font-bold text-xl">Physical Education</p>
                <p class="font-bold text-gray-700 text-center">Health & teamwork.</p>
            </div>
