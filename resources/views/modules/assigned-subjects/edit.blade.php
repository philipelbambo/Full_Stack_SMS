    ...
    <div class="py-10 bg-[#faf9f6]">
        <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <!-- Header Accent -->
                <div class="bg-[#2aafe4] px-6 py-3">
                    <h3 class="text-lg font-semibold text-white">Update Assignment</h3>
                </div>
                    ...
                    <form action="{{ route('assigned-subjects.update', $assignedSubject->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                id="faculty_name"
                                name="faculty_name"
                                value="{{ old('faculty_name', $assignedSubject->faculty_name) }}"
                                required
                        ...
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                id="subject_name"
                                name="subject_name"
                                value="{{ old('subject_name', $assignedSubject->subject_name) }}"
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E9C46A] focus:border-[#264653] outline-none transition duration-200 bg-white"
                        ...
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                id="course"
                                name="course"
                                value="{{ old('course', $assignedSubject->course) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E9C46A] focus:border-[#264653] outline-none transition duration-200 bg-white"
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                ...
                                id="semester"
                                name="semester"
                                value="{{ old('semester', $assignedSubject->semester) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E9C46A] focus:border-[#264653] outline-none transition duration-200 bg-white"
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between gap-3">
                            ...
                            <button
                                type="submit"
                                class="inline-flex items-center justify-center px-5 py-2.5 bg-[#3aabd8] text-white font-medium rounded-lg hover:bg-[#1d3540] focus:ring-2 focus:ring-[#E9C46A] focus:outline-none transition-colors duration-200 shadow-sm hover:shadow-md">
