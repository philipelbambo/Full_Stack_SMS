<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-800">Edit Archived Record</h2>
    </x-slot>

    <div class="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto w-full">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
            <form action="{{ route('archived.update', $archived) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input
                        ...
                        id="title"
                        name="title"
                        value="{{ old('title', $archived->title) }}"
                        required
                ...
                <div>
                    ...
                    <textarea
                        ...
                        placeholder="Optional description...">{{ old('description', $archived->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        id="archived_by"
                        name="archived_by"
                        value="{{ old('archived_by', $archived->archived_by) }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 bg-white shadow-sm hover:shadow-md"
